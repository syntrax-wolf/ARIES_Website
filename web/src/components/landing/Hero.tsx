...
/**
 * Cinematic parallax hero from f78adc1: looping sky + starfall + stag plate.
 * Sky drifts slower than the stag, which drifts slower than the copy.
 */
export function Hero() {
  ...
  return (
    <section ref={ref} className="relative flex min-h-[100dvh] flex-col overflow-hidden bg-night">
      ...
      <motion.div style={{ y: deer }} className="absolute inset-x-0 bottom-0 z-[3]">
        <img
          src="/images/landing/hero-stag.webp"
