...
/**
 * Landing footer — ported from the aries-website-26 redesign. Dark navy block
 * with a mountain silhouette baked in, brand + link columns + newsletter.
 */
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1480px] px-6 pb-16 lg:px-10">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1.6fr]">
          ...
          <div className="max-w-xs">
            <Link href="/" className="-my-1 inline-flex items-center gap-3 py-1">
              <AriesLogo tone="light" />
            </Link>
